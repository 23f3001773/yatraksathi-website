        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* Facebook */}
              {/* 👇 Neeche href ke andar apna Facebook Link paste karo */}
              <a 
                href="https://www.facebook.com/profile.php?id=61584239009632" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#ea2330] transition-colors text-white"
              >
              ...
              {/* Instagram */}
              {/* 👇 Neeche href ke andar apna Instagram Link paste karo */}
              <a 
                href="https://www.instagram.com/yatra_k_sathi/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#ea2330] transition-colors text-white"
              >
              ...
              {/* Twitter / X */}
              {/* 👇 Neeche href ke andar apna Twitter Link paste karo */}
              <a 
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/" className="hover:text-[#ea2330] transition-colors">Home</Link></li>
              <li><Link href="/about" className="hover:text-[#ea2330] transition-colors">About Us</Link></li>
              <li><Link href="/packages" className="hover:text-[#ea2330] transition-colors">Tour Packages</Link></li>
              <li><Link href="/taxi" className="hover:text-[#ea2330] transition-colors">Taxi Service</Link></li>
              <li><Link href="/contact" className="hover:text-[#ea2330] transition-colors">Contact Us</Link></li>
              <li><Link href="/privacy" className="hover:text-[#ea2330] transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="hover:text-[#ea2330] transition-colors">Terms & Conditions</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@yatraksathi.com</span>
              </li>
            </ul>
          </div>
